                        ...
                        <td class="text-center cursor-pointer">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" wire:click="delete({{ $user->id }})" wire:confirm="Xác nhận xoá khách hàng!">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click="updateUser">Lưu thay đổi</button>
                </div>
            </div>
            <!-- </form> -->
        </div>
